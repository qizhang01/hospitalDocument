<template>
	<div class="container">
        <top-title :patientInfo="patientInfo" tableName="肌力分级评估表"></top-title>
        <table>
          <thead>
            <tr>
              <td rowspan="2">表现</td>
        ...
        <el-dialog
            ...
            :show-close = "false"
        >
			<mucleLevelEditor></mucleLevelEditor>
			<template #footer>
...
<script setup>
    ...
    import mucleLevelEditor from "./editors/mucleLevelEditor.vue"
